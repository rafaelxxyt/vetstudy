...
export const reviewQuestions: ReviewQuestion[] = [
  {
    ...
    shortAnswer: 'A genitália externa é formada pelo vestíbulo, lábios vulvares e clitóris. O vestíbulo é a região de entrada/transição para a vagina, os lábios vulvares protegem a abertura externa e o clitóris está relacionado à sensibilidade sexual.',
    explanation: 'Quando a pergunta pede genitália externa, a resposta deve incluir vestíbulo, lábios vulvares e clitóris. O vestíbulo funciona como região de entrada e transição para a vagina, os lábios vulvares fazem a proteção externa e o clitóris participa da sensibilidade sexual.',
    memorize: 'Vestíbulo + lábios vulvares + clitóris.',
    attention: 'Se a pergunta for sobre partes externas, evite colocar vagina e cérvix como resposta principal.',
    tags: ['Anatomia'],
  },
  {
    number: 2,
  ...
  },
  {
    ...
    shortAnswer: 'A fase provável é o estro, com predomínio de estrogênio, muco claro e receptividade/inquietação. Esse período se relaciona à fase proliferativa; a fase secretora ocorre sob ação da progesterona, principalmente no metaestro/diestro.',
    explanation: 'Muco claro e comportamento inquieto são sinais clássicos de ação estrogênica elevada. Essa combinação aponta para receptividade sexual ativa, compatível com o cio. A conduta continua sendo confirmar o cio e inseminar ou manejar dentro da janela adequada.',
    memorize: 'Estro = estrogênio = fase proliferativa. Metaestro/diestro = progesterona = fase secretora.',
  ...
  },
  {
    ...
    shortAnswer: 'As fases são proestro, estro, metaestro e diestro. O estrogênio predomina no proestro e estro; a progesterona predomina no metaestro e diestro.',
  ...
  },
  {
    ...
    shortAnswer: 'O fotoperíodo influencia a reprodução porque a luz altera a secreção de melatonina, que interfere no eixo hipotálamo-hipófise-gônadas e modifica a atividade reprodutiva. Ovelhas e cabras ciclam melhor em dias curtos; éguas ciclam melhor em dias longos.',
  ...
  },
  {
    ...
    shortAnswer: 'Evitar variação de temperatura/choque térmico, manter higiene e manipular corretamente o sêmen e o material, respeitando tempo e temperatura de descongelamento.',
  ...
  },
  {
    ...
    shortAnswer: 'A PGF2α causa luteólise do corpo lúteo funcional, reduz a progesterona e permite retorno ao cio nos próximos dias.',
  ...
  },
  {
    ...
    shortAnswer: 'O progestágeno exógeno simula a fase lútea, faz feedback negativo e impede cio/ovulação. Após sua retirada, há queda da progesterona, retomada do crescimento folicular e sincronização do estro/ovulação.',
  ...
  },
  {
    ...
    shortAnswer: 'O método clássico é a citologia vaginal. No estro predominam células superficiais cornificadas, também chamadas de queratinizadas, muitas vezes anucleares.',
