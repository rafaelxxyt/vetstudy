...
const NEWS = [
  {
    id: 1, tag: 'Infectologia', tagColor: 'text-red-400 bg-red-500/10 border-red-500/20',
  ...
  {
    id: 2, tag: 'Reprodução', tagColor: 'text-purple-400 bg-purple-500/10 border-purple-500/20',
  ...
  {
    id: 3, tag: 'Farmacologia', tagColor: 'text-teal-400 bg-teal-500/10 border-teal-500/20',
  ...
  {
    id: 4, tag: 'Cirurgia', tagColor: 'text-amber-400 bg-amber-500/10 border-amber-500/20',
  ...
  {
    id: 5, tag: 'Diagnóstico', tagColor: 'text-blue-400 bg-blue-500/10 border-blue-500/20',
  ...
  {
    id: 6, tag: 'Bem-estar', tagColor: 'text-green-400 bg-green-500/10 border-green-500/20',
    ...
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-1">
          <Newspaper size={22} className="text-teal-400" />
          <h1 className="text-2xl font-bold text-white">VetNews</h1>
        </div>
        <p className="text-slate-400 text-sm">Últimas notícias da medicina veterinária nacional e internacional</p>
      </div>
      ...
      <motion.a
        ...
        className="block bg-gradient-to-br from-teal-600/20 to-slate-800 rounded-2xl p-6 border border-teal-500/20 mb-6 cursor-pointer group"
      >
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs font-bold px-2.5 py-0.5 rounded-full bg-red-500/15 text-red-400 border border-red-500/20 flex items-center gap-1.5">
            🔴 Destaque
          </span>
        ...
        <p className="text-sm text-slate-400 leading-relaxed mb-4">{NEWS[0].summary}</p>
        <div className="flex items-center justify-between">
          <span className="text-xs text-slate-500">{NEWS[0].source}</span>
          <span className="flex items-center gap-1.5 text-xs text-teal-400 group-hover:text-teal-300 transition-colors font-medium">
      ...
      <div className="grid grid-cols-2 gap-4">
        {NEWS.slice(1).map((item, i) => (
          <motion.a
            ...
            whileHover={{ y: -2 }}
            className="block bg-slate-800 rounded-2xl p-5 border border-slate-700/80 cursor-pointer group"
          >
            ...
            <h3 className="text-sm font-semibold text-slate-200 mb-1.5 leading-snug group-hover:text-teal-300 transition-colors line-clamp-2">
              {item.title}
            </h3>
            ...
            <div className="flex items-center justify-between">
              ...
              <ExternalLink size={11} className="text-slate-600 group-hover:text-teal-400 transition-colors" />
            </div>
          </motion.a>
        ))}
      </div>
